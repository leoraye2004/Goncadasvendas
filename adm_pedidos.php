...
<!-- rodapé superior -->
                ...
                <div class="navbar-collapse collapse">
                    ...
                    <ul class="navbar-nav">
                      ...
                      <?php if(!isset($_SESSION['id_usuario']) and (!isset($_SESSION['nome']))){ ?>
                        ...
                        <li class="nav-item"> 
                          <a class="btn btn-white m-2  nav-link text-white" data-bs-toggle="offcanvas" href="#offcanvasRight" role="button" aria-controls="offcanvasRight">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header">
          <h5 id="offcanvasRightLabel">Goncadasvendas</h5>
        ...
        <?php 
          ...
          <p class="fs-5 text-muted"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
              ...
              </svg><a href="" class="text-reset text-decoration-none"> Sobre Goncadasvendas </a></p>
...
<h2 class="mb-4" style="text-align: center;">Pedidos</h2>
...
<table class="table table-hover" style="background: linear-gradient(160deg, #0093E9 0%, #80D0C7 100%);">
    <thead>
        <tr>
            <th>ID</th>
            <th>Usuário</th>
    ...
    <?php foreach($pedidos as $p){ ?>
        <tr>
            ...
            <td>
                <a href="adm_ver_pedido.php?id=<?php echo $p['id_pedido']; ?>" class="btn btn-dark btn-sm">
                    Ver
                </a>
            </td>
        </tr>
