...
<!-- menu de pesquisa: home, categoria, fav. carrinho -->
  ...
  <!----  ------->
                        ...
                        <div class="row g-0">
                            ...
                            <div class="p-5">
                                ...
                                if (is_array($listaItens) && count($listaItens) > 0) {
                                    foreach($listaItens as $linha) { 
                                        // Debug: mostrar informações do item
                                        // echo "Debug - ID Carrinho: " . $linha['id_carrinho'] . ", ID Produto: " . $linha['id_produto'] . ", Valor: " . $linha['valor_final'] . "<br>";
                            ...
                            ?>
                                ...
                                <div class="col-md-1 col-lg-1 col-xl-1 text-end">
                                    <a href="excluir_carrinho.php?id_carrinho=<?php echo $linha['id_carrinho'];?>" >
                            ...
                            <div class="p-5">
                                ...
                                <?php if (is_array($listaItens) && count($listaItens) > 0){ 
                                    $id_usuario = $_SESSION['id_usuario'];
                                    $sql = $pdo->prepare("SELECT SUM(valor_final) as total FROM carrinho WHERE id_usuario = ? AND id_carrinho IS NOT NULL");
                                ...
                                <h5 class="text-muted">R$<?php echo $total; ?></h5>
                                </div>
    ...
    <button type="button" class="mt-3 btn btn-secondary btn-block btn-lg" data-mdb-ripple-color="dark">
